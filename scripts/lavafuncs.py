...
def initialize_lava(input_path, output_path, input_type):
    ...
    lava_data = {
        "param_input": scripts.ilapfuncs.cleaned_path(input_path),
        "param_output": scripts.ilapfuncs.cleaned_path(output_path),
    ...
    db_path = output_path.joinpath('_lava_artifacts.db')
...
def lava_finalize_output(output_path):
    ...
    with open(output_path.joinpath('_lava_data.json'), 'w') as f:
